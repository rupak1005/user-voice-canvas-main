          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="relative ">
              ...
              <Input
                ...
                className="pl-12 h-12 bg-white/5 border-white/10 text-grey-300 placeholder:text-gray-500 focus:border-white/20 rounded-xl"
              />
            </div>
            <Select
            ...
            >
              ...
              <SelectContent className=" bg-background backdrop-blur-sm border-white/10 rounded-xl">
                ...
                <SelectItem value="suggestion" className="text-grey-300 hover:bg-white/10 rounded-lg ">💡 Suggestions</SelectItem>
                <SelectItem value="bug-report" className="text-grey-300 hover:bg-white/10 rounded-lg flex">🐛 Reports</SelectItem>
                <SelectItem value="feature-request" className="text-grey-300 hover:bg-white/10 rounded-lg flex">✨ Requests</SelectItem>
              </SelectContent>
            </Select>
            <Select
              value={sortBy}
